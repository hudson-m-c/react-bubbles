...
- [ ] Explain what a token is used for.
	...
	A token is used for authentication when accessing an API's more protected functionality.

- [ ] What steps can you take in your web apps to keep your data secure?

	We can add a PrivateRoute that verifies a token has been recieved.

- [ ] Describe how web servers work.

	A web server hosts the code for a website and is listening for commands
